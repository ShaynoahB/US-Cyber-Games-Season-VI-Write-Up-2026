...
4. Intercepted the application's traffic using Burp Suite and identified a request to the endpoint: "/api/incidents?public=1". The "?public=1" query parameter stood out so I researched that and found out that 1 = private and 0 = public

<img width="482" height="150" alt="image" src="https://github.com/user-attachments/assets/3004b7a2-daca-4fc5-b1e5-def9a37b29b0" />

5. Modified the request by changing the parameter value from 1 to 0 and resent the request through Burp Suite. 
