...
5.  So in the csv file that list all the crew members, I looked for the "master" in which there was a text that was encoded in Base64 in which i put in CyberChef to decode the flag
